...
public enum DungeonWords implements ITranslated {
    ...
    MAP_ITEM_USE_INFO("Right Click the [Map Device Block] and place the map in its slot to start it."),
    RELIC_ITEM_INFO("Right Click the [Map Device Block] and place Relics in its slots."),
