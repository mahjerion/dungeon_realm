...
public class PinnacleUpgradeMod extends MapMod {
    public PinnacleUpgradeMod(String id) {
        super(id, id);
    }
    ...
    public Class<?> getClassForSerialization() {
        return PinnacleUpgradeMod.class;
    }

    @Override
    public TranslationBuilder createTranslationBuilder() {
        return TranslationBuilder.of(DungeonMain.MODID).desc(ExileTranslation.registry(this, "Adds the Pinnacle Arena"));
    }
}
